    ...
    await prisma.interactiveTask.create({
      data: {
        ...
        config: {
          ...
          pairs: [
            { id: "img1", cardA: "Карточка 1", cardB: "Карточка 1", image: "/materials/1.png" },
            { id: "img2", cardA: "Карточка 2", cardB: "Карточка 2", image: "/materials/2.png" },
            { id: "img3", cardA: "Карточка 3", cardB: "Карточка 3", image: "/materials/3.png" },
            { id: "img4", cardA: "Карточка 4", cardB: "Карточка 4", image: "/materials/4.png" },
            { id: "img5", cardA: "Карточка 5", cardB: "Карточка 5", image: "/materials/5.png" },
            { id: "img6", cardA: "Карточка 6", cardB: "Карточка 6", image: "/materials/6.png" },
            { id: "img7", cardA: "Карточка 7", cardB: "Карточка 7", image: "/materials/7.png" },
            { id: "img8", cardA: "Карточка 8", cardB: "Карточка 8", image: "/materials/8.png" },
            { id: "img9", cardA: "Карточка 9", cardB: "Карточка 9", image: "/materials/9.png" },
            { id: "img10", cardA: "Карточка 10", cardB: "Карточка 10", image: "/materials/10.png" },
          ],
